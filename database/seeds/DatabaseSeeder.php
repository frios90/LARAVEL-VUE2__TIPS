...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
         ...
         */        
            Company::create([
                'rut' => '17.482.835-0',
                'name' => 'Fejhu Desarrollos',
                'legal_name' => 'Fejhu Desarrollos',
                'contact' => 'Francisco Javier Rios Castillo',
                'email' => 'f.j.rios.cas@homail.es',
                'phone' => 949500353,
                'since' => date('Y-m-d'),
                'commune_id' => Commune::where('name', '=', 'Santiago')->first()->id,
                'address' => 'Av. Club Hípico 475 811, Stgo. Centro.'
            ]); 

            Company::create([
                'rut' => '1-9',
                'name' => 'Cuenta Bar Demo 1',
                'legal_name' => 'Cuenta Bar Demo 1',
                'contact' => 'Contacto bar demo 1',
                'email' => 'demo1@fejhu.com',
                'phone' => 949500353,
                'since' => date('Y-m-d'),
                'commune_id' => Commune::where('name', '=', 'Santiago')->first()->id,
                'address' => 'Av. Club Hípico 475 811, Stgo. Centro.'
 ...
 */
        User::insert([
            ...
            'phone'      => 949500353,
            'address'    => 'Av. Club Hípico 475 811, Stgo. Centro.',
            'profile_id' => Profile::where('label', '=', 'SUPER_ADMIN')->first()->id,
        ...
        User::insert([
            'rut'        => '19',
            'name'       => 'Usuario bar demo 1',
            'email'      => 'demo1@fejhu.cl',
            'password'   => bcrypt('secret'),
            'phone'      => 949500353,
            'address'    => 'Av. demo bar 1',
            'profile_id' => Profile::where('label', '=', 'CONTACT')->first()->id,
            'company_id' => Company::where('rut', '=', '1-9')->first()->id,
            'created_at' => $now,
            'updated_at' => $now
            ]);    
/**
...
/**CREACIÓN DE STAFF */
        factory(Staff::class)->times(15)->create();  
        factory(Staff::class)->times(15)->create(['company_id' => Company::where('rut', '=', '1-9')->first()->id]);  
/**JORNADAS */
        Working::insert(
            [
                'name' => 'morning',
