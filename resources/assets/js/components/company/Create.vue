                ...
                <form action="" class="tm-edit-product-form">
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="date" class="form-control form-control-sm  mantainer-input"  v-model="since" name="since">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control form-control-sm  mantainer-input"  v-model="legal_name" name="legal_name">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control form-control-sm  mantainer-input"  v-model="contact" name="contact">
    ...
    export default {        
        ...
        methods: {
                ...
                postCreate() {
                    ...
                    var self = this
                    this.$http.post('/company-store', data)
                        .then(response => {
